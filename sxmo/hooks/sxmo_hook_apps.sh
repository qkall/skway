...
write_line_app() {
        ...
        elif [ -d "$HOME/.local/share/flatpak/app/$executable" ]; then
                write_line "$label" "$command"
        elif [ -d "/var/lib/flatpak/app/$executable" ]; then
                write_line "$label" "$command"
        fi
}
...
#write_line_app ani-cli "$icon_mvi Anime" "sxmo_terminal.sh ani-cli --dub"
write_line_app alacritty "$icon_trm Alacritty" "alacritty"
write_line_app amberol "$icon_mus Amberol" "amberol $XDG_MUSIC_DIR"
write_line_app uk.co.piggz.amazfish "$icon_wat Amazfish" "flatpak run uk.co.piggz.amazfish"
...
write_line_app io.github.cosmic_utils.camera "$icon_cam CosCam" "flatpak run io.github.cosmic_utils.camera"
...
write_line_app authenticator "$icon_bok Gnome Authenticator" "authenticator"
...
write_line_app gnome-podcasts "$icon_mus Gnome Podcasts" "gnome-podcasts"
...
write_line_app qutebrowser "$icon_msg Gomuks" "qutebrowser http://localhost:29325/"
...
write_line_app gzdoom "$icon_gam gzdoom" "gzdoom"
write_line_app halloy "$icon_msg Halloy" "halloy"
...
write_line_app kdeconnect-app "$icon_cfg Kdeconnect" "kdeconnect-app"
write_line_app kdenlive "$icon_img Kdenlive" "kdenlive"
...
write_line_app net.codelogistics.letters "$icon_edt Letters" "flatpak run net.codelogistics.letters"
...
write_line_app com.konstantintutsch.Lock "$icon_edt Lock" "flatpak run com.konstantintutsch.Lock"
...
write_line_app meshzen.py "$icon_net Meshtastic" "~/.local/share/pipx/venvs/meshtastic/bin/python3 meshzen.py"
write_line_app mgba-qt "$icon_gam mgba" "mgba-qt"
write_line_app midori "$icon_glb Midori" "midori"
write_line_app io.github.halfmexican.Mingle "$icon_msg Mingle" "flatpak run io.github.halfmexican.Mingle"
write_line_app moonlight "$icon_net Moonlight" "moonlight"
...
write_line_app neochat "$icon_msg Neochat" "neochat"
...
write_line_app org.openmw.OpenMW "$icon_gam Morrowind" "flatpak run org.openmw.OpenMW"
...
write_line_app im.pidgin.Pidgin3 "$icon_msg Pidgin" "flatpak run im.pidgin.Pidgin3"
write_line_app tubefeeder "$icon_mvi Pipeline" "tubefeeder"
write_line_app podboat "$icon_pod Podboat" "sxmo_terminal.sh podboat"
write_line_app org.gnome.Polari "$icon_msg Polari" "flatpak run org.gnome.Polari"
...
write_line_app osmin "$icon_map OLS" "~/sxmop6/launchers/ols_launcher.sh"
...
write_line_app page.codeberg.tpikonen.satellite "$icon_map Satellite" "flatpak run page.codeberg.tpikonen.satellite"
...
write_line_app com.shatteredpixel.shatteredpixeldungeon "$icon_gam Shattered Pixel Dungeon" "flatpak run com.shatteredpixel.shatteredpixeldungeon"
write_line_app ro.hume.cosmin.ShoppingList "$icon_bok Shopping List" "flatpak run ro.hume.cosmin.ShoppingList"
...
write_line_app supertuxkart "$icon_gam SuperTuxKart" "supertuxkart"
...
write_line_app thunar "$icon_dir Thunar" "thunar"
...
write_line_app org.kde.tokodon "$icon_rss Tokodon" "flatpak run org.kde.tokodon"
write_line_app transmission-gtk "$icon_red Transmission" "transmission-gtk"
